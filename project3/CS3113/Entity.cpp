...
Entity::Entity() : mPosition {0.0f, 0.0f}, mMovement {0.0f, 0.0f}, 
                   ...
                   mSpriteSheetDimensions {}, mDirection {OFF}, 
...
Entity::Entity(Vector2 position, Vector2 scale, const char *textureFilepath) : 
    ...
    mDirection {OFF}, mAnimationAtlas {{}}, mAnimationIndices {}, 
    mFrameSpeed {0}, mSpeed {DEFAULT_SPEED}, mAngle {0.0f} { }

Entity::Entity(Vector2 position, Vector2 scale, const char *textureFilepath, 
        TextureType textureType, Vector2 spriteSheetDimensions, std::map<Engine, 
        ...
        mAnimationAtlas {animationAtlas}, mDirection {OFF}, 
        mAnimationIndices {animationAtlas.at(OFF)}, 
...
void Entity::update(float deltaTime, const std::vector<Entity*>& collidableEntities)
{
